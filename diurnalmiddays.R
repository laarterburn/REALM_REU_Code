...
#rbind
Data<-rbind(Data2015LGN, Data2016LGN, Data2017LGN, Data2018LGN, Data2019LGN)
...
plot(Data$Time_UTC, Data$CO2_LGN, xlab="Year", ylab="CO2 [ppm]", main="5th Percentile Baseline of CO2 Emissions in Logan, Utah between 2015-2019 at 12:00-15:00 MST", type="l")
...
xslopeDJF <- signif(lm_DJF$coef[[2]], 3)
xpDJF <- signif(summary(lm_DJF)$coef[2,4], 3)
legend(x="bottomright", y=2, legend=c(paste("P-value:",xpDJF), paste("Slope:",xslopeDJF)))
